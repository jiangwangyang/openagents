    ...
    TableSchema {
        ...
        columns: &[
            ...
            ColumnSchema {
                ...
                column_type: "INTEGER",
                not_null: true,
                suffix: "REFERENCES t_model_provider(id) ON DELETE RESTRICT",
            },
            ColumnSchema {
                name: "model",
                column_type: "TEXT",
    ...
    TableSchema {
        ...
        columns: &[
            ...
            ColumnSchema {
                ...
                column_type: "INTEGER",
                not_null: false,
                suffix: "REFERENCES t_agent(id) ON DELETE RESTRICT",
            },
            ColumnSchema {
                name: "enabled",
                column_type: "INTEGER",
    ...
    TableSchema {
        ...
        columns: &[
            ...
            ColumnSchema {
                ...
                column_type: "INTEGER",
                not_null: false,
                suffix: "REFERENCES t_task(id) ON DELETE CASCADE",
            },
            ColumnSchema {
                name: "schedule_id",
                column_type: "INTEGER",
                not_null: false,
                suffix: "REFERENCES t_schedule(id) ON DELETE RESTRICT",
            },
            ColumnSchema {
                name: "agent_id",
                column_type: "INTEGER",
    ...
    TableSchema {
        ...
        columns: &[
            ...
            ColumnSchema {
                ...
                column_type: "INTEGER",
                not_null: true,
                suffix: "REFERENCES t_conversation(id) ON DELETE CASCADE",
            },
