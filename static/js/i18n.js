...
const I18N = {
    en: {
        ...
        common: {save: 'Save', cancel: 'Cancel', abort: 'Cancel', purge: 'Delete', sortAsc: '\u2191 ASC', sortDesc: '\u2193 DESC', sortToggle: 'Toggle sort order', expand: 'EXPAND', collapse: 'COLLAPSE', fetchFailed: 'LOAD FAILED', requiredMissing: 'REQUIRED FIELDS MISSING.', creationFault: 'CREATE FAILED', purgeFailure: 'DELETE FAILED', syncCrashed: 'OPERATION FAILED', none: 'NONE', inheritedEnv: 'Inherited Environment', description: 'Description'},
        task: {viewTitle: 'Task Pipeline Management', newTask: '+ New Task', title: 'Task Title', content: 'Task Content', workDir: 'Working Directory', candidateAgents: 'Candidate Agents', titlePlaceholder: 'e.g. Daily Code Review Pipeline', contentPlaceholder: '# Enter task description...', stageProgress: 'Stage Progress', empty: 'NO TASK PIPELINES FOUND', noAgents: 'NO REGISTERED AGENTS', notStarted: 'PIPELINE NOT STARTED. NO STAGES YET.', generating: '⚡ Generating... Click to view live stream', reviewWaiting: '⏸ PIPELINE PAUSED. WAITING FOR YOUR REVIEW FEEDBACK:', reviewRequired: 'REVIEW FEEDBACK IS REQUIRED.', reviewFault: 'REVIEW FAILED', noMessages: 'NO MESSAGES', agentRequired: 'AGENT IS REQUIRED.', needCandidate: 'NO CANDIDATE AGENTS ON THIS TASK', launched: 'TASK STARTED.', alreadyRunning: 'TASK ALREADY RUNNING', startFault: 'START FAILED', purgeTitle: 'DELETE TASK', purgeText: 'Delete task [{name}]? All attached stage conversations will be permanently deleted.', viewDesc: 'A task is a multi-agent pipeline: work is split into stages, dispatched to candidate agents, and can pause for your review. Register agents in the AGENT page first.', emptyHint: 'TIP: A task dispatches stages to candidate agents. Register at least one agent in the AGENT page, then click "+ New Task".', statusIdle: 'IDLE', statusRunning: 'RUNNING', statusReview: 'REVIEW', statusDone: 'DONE', statusFailed: 'FAILED', stageCount: '{count} STAGES', stop: 'Stop Task', stopped: 'TASK STOPPED.', stopFault: 'STOP FAILED', notRunning: 'TASK IS NOT RUNNING', submitRun: 'Submit & Run', launch: 'Start', launchPlaceholder: 'Start execution', resumePlaceholder: 'Continue execution...', failedPlaceholder: 'Task failed. Continue execution', complete: 'Complete', completePlaceholder: 'Done', resume: 'Continue', reviewNeeded: 'TASK [{name}] IS WAITING FOR YOUR REVIEW', runningNoPurge: 'CANNOT DELETE A RUNNING TASK', openInDialog: 'OPEN IN DIALOG'},
        ...
        cron: {viewTitle: 'Scheduled Cron Processes', newCron: '+ New Cron', name: 'Task Name', namePlaceholder: 'e.g. Daily Code Review', agent: 'Agent', minute: 'Min', hour: 'Hour', day: 'Day', month: 'Month', week: 'Weekday', contentLabel: 'Task Content', contentPlaceholder: '# Enter task description...', empty: 'NO SCHEDULED CRON PROCESSES FOUND', unnamed: 'Unnamed Task', workingDir: 'Working Dir', nextFire: 'Next Fire', triggerSpec: 'Trigger Spec', execContent: 'Task Content', suspended: 'Suspended', enabled: 'ENABLED', disabled: 'DISABLED', enable: 'Enable', disable: 'Disable', triggerNow: 'Run Now', triggered: 'CRON TASK [{name}] TRIGGERED.', purgeTitle: 'DELETE CRON TASK', purgeText: 'Delete scheduled task [{name}]? It will no longer run.', formatHint: 'Field order: Min Hour Day Month Weekday. Each accepts digits and * , - /  (e.g. Min=0 Hour=9 = every day at 09:00)', invalidFormat: 'CRON FIELDS MAY ONLY CONTAIN DIGITS AND * , - /', execHistory: 'Execution History', notTriggered: 'NOT TRIGGERED YET. NO EXECUTION RECORDS.', viewDesc: 'Cron tasks fire automatically on a schedule (Min Hour Day Month Weekday) with no manual intervention. Execution history is kept on each card. Register an agent first.', emptyHint: 'TIP: Cron tasks run automatically on schedule. Register an agent in the AGENT page first, then click "+ New Cron".'},
        ...
        config: {viewTitle: 'System Runtime Configurations', newProvider: '+ New Provider', newProviderCard: '+ New Model Provider', providerName: 'Provider Name', providerNamePlaceholder: 'e.g. deepseek', protocolType: 'Protocol Type', baseUrl: 'Base URL Endpoint', secretToken: 'Secret Token (API Key)', toggleSecret: 'Show / Hide Secret', endpointMissing: 'Endpoint missing', nameRequired: 'PROVIDER NAME IS REQUIRED.', injectionFault: 'CREATE FAILED', synced: 'PROVIDER [{name}] SAVED.', purgeTitle: 'DELETE MODEL PROVIDER', purgeText: 'Delete model provider [{name}]? Agents using this provider will stop working.', viewDesc: 'Model providers (protocol / base URL / API key) power every agent. Adding a provider is step one before creating agents.', empty: 'NO MODEL PROVIDERS REGISTERED', emptyHint: 'STEP ONE: Click "+ New Provider" to add a model provider, required before creating agents or starting conversations.'},
        input: {cwdTitle: 'Set Directory Context', unset: 'UNSET', agentTitle: 'Select Agent', providerTitle: 'Select Provider', modelTitle: 'Select Model', modelPlaceholder: 'MODEL', thinkingTitle: 'Thinking Mode', thinkingOff: 'OFF', thinkingMinimal: 'MINIMAL', thinkingLow: 'LOW', thinkingMedium: 'MEDIUM', thinkingHigh: 'HIGH', thinkingXhigh: 'XHIGH', thinkingMax: 'MAX', placeholder: 'Enter instructions...', readonlyPlaceholder: 'Read-only conversation from task/cron. Sending is disabled.', execute: 'Send', stop: 'Stop', charLimit: 'INPUT LIMIT REACHED ({max} CHARS). EXCESS CONTENT WAS DISCARDED.', contextLocked: 'Conversation started. Directory and agent are locked.', cwdLabel: 'WORKDIR:', modelListUnavailable: 'MODEL LIST UNAVAILABLE. TYPE THE MODEL NAME MANUALLY.', promptSourceAgent: 'PROMPT: AGENT [{name}]', promptSourceFile: 'PROMPT: {path}', promptSourcePending: 'PROMPT: WILL LOAD FROM {path} ON START (IF EXISTS)', promptSourceNone: 'PROMPT: NONE'},
        ...
        stream: {purgeTitle: 'DELETE CONVERSATION', purgeText: 'Delete conversation [{name}]? This action cannot be undone.', startFailed: 'START FAILED', configMissing: 'PLEASE SELECT A PROVIDER AND ENTER A MODEL FIRST.', workdirMissing: 'PLEASE SET A WORKING DIRECTORY (WORKDIR) FIRST.', unknownError: 'Unknown Error', thoughtProcess: 'Thought Process', systemPrompt: 'System Prompt', callPrefix: 'Call', tool: 'Tool', toolError: 'Error', toolResult: 'Result', usageIn: 'in', usageOut: 'out', usageCache: 'cache', usageTotal: 'this turn', stopped: '\u23f8 MANUALLY STOPPED', stopFailed: 'STOP FAILED', rollback: 'Rollback to this message', rollbackTitle: 'ROLLBACK CONVERSATION', rollbackText: 'Rollback to this message? It and all later messages will be permanently deleted, and its content will be copied into the input box.', rollbackFailed: 'ROLLBACK FAILED'},
    ...
    zh: {
        ...
        sidebar: {newDialog: '+ 新建会话', history: '历史会话', noHistory: '暂无历史会话'},
        nav: {dialog: '会话', task: '任务', cron: '定时', agent: '智能体', skill: '技能', mcp: 'MCP', config: '配置', dialogTip: '与智能体直接对话', taskTip: '多智能体协作流水线，分阶段执行并可审核', cronTip: '按 cron 规则自动触发任务', agentTip: '注册智能体：模型、提示词与行为', skillTip: '从本地技能目录自动扫描加载的技能', mcpTip: '注册外部工具服务，供智能体调用', configTip: '配置模型供应商（协议/地址/密钥）'},
        ...
        common: {save: '保存', cancel: '取消', abort: '取消', purge: '删除', sortAsc: '↑ 升序', sortDesc: '↓ 降序', sortToggle: '切换排序', expand: '展开', collapse: '收起', fetchFailed: '加载失败', requiredMissing: '必填字段缺失。', creationFault: '创建失败', purgeFailure: '删除失败', syncCrashed: '操作失败', none: '无', inheritedEnv: '继承环境', description: '描述'},
        task: {viewTitle: '任务流水线管理', newTask: '+ 新建任务', title: '任务标题', content: '任务内容', workDir: '工作目录', candidateAgents: '候选智能体', titlePlaceholder: '例如：每日代码审查流水线', contentPlaceholder: '# 输入任务描述...', stageProgress: '阶段进展', empty: '暂无任务流水线', noAgents: '未注册智能体', notStarted: '流水线未启动，暂无阶段。', generating: '⚡ 生成中...点击查看实时流', reviewWaiting: '⏸ 流水线已暂停，等待您的审核意见：', reviewRequired: '请填写审核意见。', reviewFault: '审核提交失败', noMessages: '暂无消息', agentRequired: '请选择智能体。', needCandidate: '该任务未配置候选智能体', launched: '任务已启动。', alreadyRunning: '任务已在运行中', startFault: '启动失败', purgeTitle: '删除任务', purgeText: '确定要删除任务 [{name}] 吗？其关联的所有阶段会话将被永久删除。', viewDesc: '任务是多智能体协作的流水线：工作被拆分为阶段，分派给候选智能体执行，关键节点可暂停等待您审核。使用前请先在「智能体」页注册智能体。', emptyHint: '提示：任务会将各阶段分派给候选智能体执行。请先在「智能体」页注册至少一个智能体，再点击右上角「+ 新建任务」。', statusIdle: '待启动', statusRunning: '运行中', statusReview: '待审核', statusDone: '已完成', statusFailed: '运行失败', stageCount: '{count} 个阶段', stop: '停止任务', stopped: '任务已停止。', stopFault: '停止失败', notRunning: '任务未在运行', submitRun: '提交并执行', launch: '开始执行', launchPlaceholder: '开始执行', resumePlaceholder: '继续执行', failedPlaceholder: '任务运行失败，重新继续执行', complete: '完成任务', completePlaceholder: '完成', resume: '继续执行', reviewNeeded: '任务 [{name}] 等待您的审核', runningNoPurge: '运行中的任务不可删除', openInDialog: '在对话页打开'},
...
function applyStaticI18n() {
    ...
    // 侧边栏空历史占位文案由 CSS ::after 呈现, 经 CSS 变量注入实现本地化
    document.documentElement.style.setProperty('--no-history-text', `'${t('sidebar.noHistory')}'`);
}
