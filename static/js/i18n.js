...
const I18N = {
    ...
    zh: {
        ...
        agent: {viewTitle: '已注册智能体名册', newAgent: '+ 新建智能体', name: '智能体名称', prompt: '系统提示词', namePlaceholder: '例如：代码审查员', descPlaceholder: '例如：审查 PR 并报告问题', promptPlaceholder: '# 输入智能体系统提示词...', empty: '暂无已注册智能体', rosterCrashed: '名册加载失败', nameRequired: '智能体名称为必填项。', providerRequired: '必须选择模型供应商。', commitFailure: '提交失败', synced: '智能体 [{name}] 已同步。', purgeTitle: '删除智能体', purgeText: '确定要将智能体 [{name}] 从系统名册中移除吗？其关联会话将被立即解绑。'},
        cron: {viewTitle: '定时任务管理', newCron: '+ 新建定时任务', name: '任务名称', namePlaceholder: '例如：每日行情抓取', workDirPlaceholder: '例如：/home/project/miniclaw', agent: '智能体', noAgent: '-- 无 --', minute: '分', hour: '时', day: '日', month: '月', week: '周', contentLabel: '执行内容 / 脚本上下文', contentPlaceholder: '# 输入详细脚本步骤...', empty: '暂无定时任务', unnamed: '未命名任务', workingDir: '工作目录', nextFire: '下次触发', triggerSpec: '触发规则', execContent: '执行内容', suspended: '已暂停', enabled: '已启用', disabled: '已禁用', enable: '启用', disable: '禁用', synced: '定时任务 [{name}] 已同步。', purgeTitle: '删除定时任务', purgeText: '确定要销毁定时任务 [{name}] 吗？该任务序列将从内核队列中清除。', purgeFailed: '删除失败'},
        skill: {viewTitle: '已注册智能体技能', empty: '未提取到技能', unnamed: '未命名技能', noDesc: '未分配描述。', fsPath: '文件路径', sourceManifest: '源清单'},
        mcp: {viewTitle: 'Model Context Protocol 服务', newServer: '+ 新建服务', keyName: '服务唯一名称', keyPlaceholder: '例如：vserver_wind_financial_data', descPlaceholder: '例如：Wind 金融数据服务', protocolArch: '协议类型', urlEndpoint: '连接地址', headersLabel: 'HTTP 请求头（JSON 格式）', command: '执行命令', args: '参数（逗号分隔）', empty: '暂无已注册 MCP 服务', localContext: '本地上下文', testProbe: '测试探测', protocolType: '协议类型', targetUrl: '目标地址', httpHeaders: 'HTTP 请求头（JSON）', cmdExec: '执行命令', exposedCaps: '暴露的能力清单', topologyCrashed: '拓扑加载失败', nameRequired: '服务唯一名称为必填项。', headersInvalid: '请求头必须是合法的 JSON 字符串。', regRejected: '注册被拒绝', synced: 'MCP 服务 [{name}] 已同步。', purgeTitle: '删除 MCP 节点', purgeText: '确定要将 MCP 节点 [{name}] 从系统环境中移除吗？关联的桥接通道将被立即断开。', connectedNoTools: '连接成功，未暴露任何工具。', noManifest: '未提供说明。', sessionCrashed: '会话崩溃：连接被拒绝'},
