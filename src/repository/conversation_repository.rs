...
pub async fn list_conversations_by_schedule_id(
    pool: &SqlitePool,
    schedule_id: i64,
...
pub async fn list_conversations_by_task_id(
    pool: &SqlitePool,
    task_id: i64,
) -> Result<Vec<ConversationEntity>, sqlx::Error> {
    sqlx::query_as::<_, ConversationEntity>(
...
pub async fn get_latest_task_conversation_state(
    pool: &SqlitePool,
    task_id: i64,
) -> Result<Option<LatestConversationState>, sqlx::Error> {
...
pub async fn list_task_conversation_history(
    pool: &SqlitePool,
    task_id: i64,
) -> Result<Vec<ConversationHistorySummary>, sqlx::Error> {
