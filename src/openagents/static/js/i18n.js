...
const I18N = {
    en: {
        ...
        input: {cwdTitle: 'Set Directory Context', unset: 'UNSET', agentTitle: 'Select Agent', placeholder: 'Enter instructions...', execute: 'Execute'},
    ...
    zh: {
        ...
        input: {cwdTitle: '设置目录上下文', unset: '未设置', agentTitle: '选择智能体', placeholder: '输入指令...', execute: '执行'},
