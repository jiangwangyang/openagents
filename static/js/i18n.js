...
const I18N = {
    en: {
        ...
        common: {save: 'Save', cancel: 'Cancel', abort: 'Cancel', purge: 'Delete', refresh: 'Refresh', start: 'Start', review: 'Review', fetchFailed: 'LOAD FAILED', requiredMissing: 'REQUIRED FIELDS MISSING.', creationFault: 'CREATE FAILED', purgeFailure: 'DELETE FAILED', syncCrashed: 'OPERATION FAILED', none: 'NONE', inheritedEnv: 'Inherited Environment', description: 'Description'},
    ...
    zh: {
        ...
        common: {save: '保存', cancel: '取消', abort: '取消', purge: '删除', refresh: '刷新', start: '启动', review: '审核', fetchFailed: '加载失败', requiredMissing: '必填字段缺失。', creationFault: '创建失败', purgeFailure: '删除失败', syncCrashed: '操作失败', none: '无', inheritedEnv: '继承环境', description: '描述'},
