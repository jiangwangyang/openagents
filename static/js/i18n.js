...
const I18N = {
    ...
    zh: {
        ...
        mcp: {viewTitle: 'Model Context Protocol 服务', newServer: '+ 新建服务', keyName: '服务唯一名称', keyPlaceholder: '例如：vserver_wind_financial_data', descPlaceholder: '例如：Wind 金融数据服务', protocolArch: '协议类型', urlEndpoint: '连接地址', headersLabel: 'HTTP 请求头（JSON 格式）', command: '执行命令', args: '参数（逗号分隔）', empty: '暂无已注册 MCP 服务', localContext: '本地上下文', testProbe: '查看工具', protocolType: '协议类型', targetUrl: '目标地址', httpHeaders: 'HTTP 请求头（JSON）', cmdExec: '执行命令', exposedCaps: '暴露的能力清单', topologyCrashed: '拓扑加载失败', nameRequired: '服务唯一名称为必填项。', headersInvalid: '请求头必须是合法的 JSON 字符串。', regRejected: '注册被拒绝', synced: 'MCP 服务 [{name}] 已同步。', purgeTitle: '删除 MCP 节点', purgeText: '确定要将 MCP 节点 [{name}] 从系统环境中移除吗？关联的桥接通道将被立即断开。', connectedNoTools: '连接成功，未暴露任何工具。', noManifest: '未提供说明。', sessionCrashed: '会话崩溃：连接被拒绝'},
